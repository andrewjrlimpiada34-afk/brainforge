...
import { Search, Brain, Zap, Target, BookOpen, Calculator } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 pt-12 space-y-12">
        <div className="max-w-2xl">
          ...
          <div className="relative mt-8">
            ...
            <Input className="pl-10 h-12 bg-card border-white/5 rounded-xl" placeholder="Search modules..." />
          </div>
        </div>
